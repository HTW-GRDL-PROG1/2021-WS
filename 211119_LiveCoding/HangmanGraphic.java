...
public class HangmanGraphic {
    ...
    // Unterstriche) -> siehe prettyPrintWord()-Methode
    ...
    public static void main(String[] args) {
        ...
        while (verbleibendeVersuche > 0) {
            ...
            if (eingabe.length() > 1) {
                ...
                // Proper handling of longer inputs: don't check whether input matches but just
                // go back to beginning of while-loop
                continue; // bricht aktueller Durchlauf der while-Schleife ab und macht mit dem nächsten
                          // weiter
            }
            ...
            int verloreneLeben = maxAnzahlVersuche - verbleibendeVersuche;
            printHangman(verloreneLeben);
        ...
        // Wenn wir außerhalb der while-Schleife kommen, wurde die while-Schleife
        // entweder unterbrochen, weil wir gewonnen haben
    ...
    public static void printHangman(int verloreneLeben) {
        String graphicHangman = "";

        switch (verloreneLeben) {
        case 1: {
            graphicHangman = """
                       ------
                       |    |
        ...
        System.out.println(graphicHangman);
    }
